...
def MSA01(rot = [0,0,0]):
    ...
    texture.SetTextureFilename(chrono.GetChronoDataFile('textures/circuit.png'))
...
def MSA02(rot = [0,0,0]):
    ...
    # Apply texture
    texture = chrono.ChTexture()
    texture.SetTextureFilename(chrono.GetChronoDataFile('textures/plastic_cover.png'))
    texture.SetTextureScale(4, 3)
    body_brick.AddAsset(texture)
