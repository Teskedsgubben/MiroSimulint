...
def MIT_walls(system, H):
    ...
    pos_3 = chrono.ChVectorD(-1.5, 0, 9+wall_t) + chrono.ChVectorD(0, 4/3*wall_h, 0)
    ...
    add_boxShape(system, wall_l, 2/3*wall_h, wall_t, pos_3, texture_wall, [10,10]) # Positive z direction
